...
<template>
    <section class="mx-auto w-4/5 pb-6">
        <div class="grid lg:grid-cols-2 items-center gap-4 justify-center">
            <div class="lg:w-4/5 mx-auto">
                <img src="../assets/img/step1.jpg" class="shadow-2xl" />
            </div>
            ...
            <div class="lg:w-4/5 lg:order-5 mx-auto">
                <img src="../assets/img/step3.jpg" class="shadow-2xl" />
            </div>




            <div class="lg:w-4/5 lg:order-6 mx-auto">
